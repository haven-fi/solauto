...
impl AldrinV2Swap {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = AldrinV2SwapInstructionData::new().try_to_vec().unwrap();
...
pub struct AldrinV2SwapInstructionData {
    discriminator: [u8; 8],
}

impl AldrinV2SwapInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `AldrinV2Swap`.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
#[derive(Default)]
pub struct AldrinV2SwapBuilder {
    ...
    curve: Option<solana_program::pubkey::Pubkey>,
    token_program: Option<solana_program::pubkey::Pubkey>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl AldrinV2SwapBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn curve(&mut self, curve: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AldrinV2Swap {
            ...
            curve: self.curve.expect("curve is not set"),
...
/// `aldrin_v2_swap` CPI accounts.
pub struct AldrinV2SwapCpiAccounts<'a, 'b> {
    ...
    pub curve: &'b solana_program::account_info::AccountInfo<'a>,

    pub token_program: &'b solana_program::account_info::AccountInfo<'a>,
}

/// `aldrin_v2_swap` CPI instruction.
pub struct AldrinV2SwapCpi<'a, 'b> {
...
impl<'a, 'b> AldrinV2SwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AldrinV2SwapCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        account_infos.push(self.curve.clone());
...
/// Instruction builder for `AldrinV2Swap` via CPI.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
///   10. `[]` curve
///   11. `[]` token_program
pub struct AldrinV2SwapCpiBuilder<'a, 'b> {
    instruction: Box<AldrinV2SwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AldrinV2SwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AldrinV2SwapCpiBuilderInstruction {
            __program: program,
            swap_program: None,
            pool: None,
            pool_signer: None,
    ...
    #[inline(always)]
    pub fn curve(&mut self, curve: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = AldrinV2SwapCpi {
            ...
            curve: self.instruction.curve.expect("curve is not set"),
...
struct AldrinV2SwapCpiBuilderInstruction<'a, 'b> {
    ...
    curve: Option<&'b solana_program::account_info::AccountInfo<'a>>,
