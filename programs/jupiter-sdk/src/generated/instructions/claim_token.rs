...
pub struct ClaimToken {
    ...
    pub associated_token_token_program: solana_program::pubkey::Pubkey,
...
impl ClaimToken {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ClaimTokenInstructionData::new().try_to_vec().unwrap();
...
pub struct ClaimTokenBuilder {
    ...
    associated_token_token_program: Option<solana_program::pubkey::Pubkey>,
...
impl ClaimTokenBuilder {
    ...
    #[inline(always)]
    pub fn associated_token_token_program(
        &mut self,
        associated_token_token_program: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.associated_token_token_program = Some(associated_token_token_program);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ClaimToken {
            ...
            associated_token_token_program: self
                .associated_token_token_program
                .expect("associated_token_token_program is not set"),
...
pub struct ClaimTokenCpiAccounts<'a, 'b> {
    ...
    pub associated_token_token_program: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> ClaimTokenCpi<'a, 'b> {
    pub fn new(
        ...
        Self {
            ...
            mint: accounts.mint,
            associated_token_token_program: accounts.associated_token_token_program,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
            *self.associated_token_token_program.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
        ...
        account_infos.push(self.associated_token_token_program.clone());
...
impl<'a, 'b> ClaimTokenCpiBuilder<'a, 'b> {
    ...
    pub fn associated_token_token_program(
        &mut self,
        associated_token_token_program: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.associated_token_token_program = Some(associated_token_token_program);
        self
    }
    #[inline(always)]
    pub fn associated_token_program(
...
struct ClaimTokenCpiBuilderInstruction<'a, 'b> {
    ...
    associated_token_token_program: Option<&'b solana_program::account_info::AccountInfo<'a>>,
