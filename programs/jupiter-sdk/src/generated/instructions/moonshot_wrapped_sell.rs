...
impl MoonshotWrappedSell {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = MoonshotWrappedSellInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct MoonshotWrappedSellInstructionData {
    discriminator: [u8; 8],
}

impl MoonshotWrappedSellInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [248, 2, 240, 253, 17, 184, 57, 8],
        }
    }
}

/// Instruction builder for `MoonshotWrappedSell`.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
#[derive(Default)]
pub struct MoonshotWrappedSellBuilder {
...
impl MoonshotWrappedSellBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = MoonshotWrappedSell {
...
/// `moonshot_wrapped_sell` CPI accounts.
pub struct MoonshotWrappedSellCpiAccounts<'a, 'b> {
...
/// `moonshot_wrapped_sell` CPI instruction.
pub struct MoonshotWrappedSellCpi<'a, 'b> {
...
impl<'a, 'b> MoonshotWrappedSellCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: MoonshotWrappedSellCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `MoonshotWrappedSell` via CPI.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
///   11. `[]` system_program
///   12. `[writable]` user_wsol_token_account
pub struct MoonshotWrappedSellCpiBuilder<'a, 'b> {
    instruction: Box<MoonshotWrappedSellCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> MoonshotWrappedSellCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(MoonshotWrappedSellCpiBuilderInstruction {
            __program: program,
            swap_program: None,
            sender: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = MoonshotWrappedSellCpi {
...
struct MoonshotWrappedSellCpiBuilderInstruction<'a, 'b> {
