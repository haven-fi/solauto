...
impl PerpsAddLiquidity {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = PerpsAddLiquidityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct PerpsAddLiquidityInstructionData {
    discriminator: [u8; 8],
}

impl PerpsAddLiquidityInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `PerpsAddLiquidity`.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
///   13. `[]` program
#[derive(Default)]
pub struct PerpsAddLiquidityBuilder {
...
impl PerpsAddLiquidityBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = PerpsAddLiquidity {
...
/// `perps_add_liquidity` CPI accounts.
pub struct PerpsAddLiquidityCpiAccounts<'a, 'b> {
...
/// `perps_add_liquidity` CPI instruction.
pub struct PerpsAddLiquidityCpi<'a, 'b> {
...
impl<'a, 'b> PerpsAddLiquidityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: PerpsAddLiquidityCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PerpsAddLiquidity` via CPI.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
///   12. `[]` event_authority
///   13. `[]` program
pub struct PerpsAddLiquidityCpiBuilder<'a, 'b> {
    instruction: Box<PerpsAddLiquidityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PerpsAddLiquidityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PerpsAddLiquidityCpiBuilderInstruction {
            __program: program,
            swap_program: None,
            owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PerpsAddLiquidityCpi {
...
struct PerpsAddLiquidityCpiBuilderInstruction<'a, 'b> {
