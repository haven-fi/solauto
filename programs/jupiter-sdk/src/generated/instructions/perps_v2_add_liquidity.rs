...
impl PerpsV2AddLiquidity {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = PerpsV2AddLiquidityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct PerpsV2AddLiquidityInstructionData {
    discriminator: [u8; 8],
}

impl PerpsV2AddLiquidityInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `PerpsV2AddLiquidity`.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
///   14. `[]` program
#[derive(Default)]
pub struct PerpsV2AddLiquidityBuilder {
...
impl PerpsV2AddLiquidityBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = PerpsV2AddLiquidity {
...
/// `perps_v2_add_liquidity` CPI accounts.
pub struct PerpsV2AddLiquidityCpiAccounts<'a, 'b> {
...
/// `perps_v2_add_liquidity` CPI instruction.
pub struct PerpsV2AddLiquidityCpi<'a, 'b> {
...
impl<'a, 'b> PerpsV2AddLiquidityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: PerpsV2AddLiquidityCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PerpsV2AddLiquidity` via CPI.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
///   13. `[]` event_authority
///   14. `[]` program
pub struct PerpsV2AddLiquidityCpiBuilder<'a, 'b> {
    instruction: Box<PerpsV2AddLiquidityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PerpsV2AddLiquidityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PerpsV2AddLiquidityCpiBuilderInstruction {
            __program: program,
            swap_program: None,
            owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PerpsV2AddLiquidityCpi {
...
struct PerpsV2AddLiquidityCpiBuilderInstruction<'a, 'b> {
