...
impl StabbleWeightedSwap {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = StabbleWeightedSwapInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct StabbleWeightedSwapInstructionData {
    discriminator: [u8; 8],
}

impl StabbleWeightedSwapInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `StabbleWeightedSwap`.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
#[derive(Default)]
pub struct StabbleWeightedSwapBuilder {
...
impl StabbleWeightedSwapBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = StabbleWeightedSwap {
...
/// `stabble_weighted_swap` CPI accounts.
pub struct StabbleWeightedSwapCpiAccounts<'a, 'b> {
...
/// `stabble_weighted_swap` CPI instruction.
pub struct StabbleWeightedSwapCpi<'a, 'b> {
...
impl<'a, 'b> StabbleWeightedSwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: StabbleWeightedSwapCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `StabbleWeightedSwap` via CPI.
///
/// ### Accounts:
///
///   0. `[]` swap_program
...
///   11. `[]` vault_program
///   12. `[]` token_program
pub struct StabbleWeightedSwapCpiBuilder<'a, 'b> {
    instruction: Box<StabbleWeightedSwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> StabbleWeightedSwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(StabbleWeightedSwapCpiBuilderInstruction {
            __program: program,
            swap_program: None,
            user: None,
            user_token_in: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = StabbleWeightedSwapCpi {
...
struct StabbleWeightedSwapCpiBuilderInstruction<'a, 'b> {
