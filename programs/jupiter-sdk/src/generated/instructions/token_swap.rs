...
impl TokenSwap {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = TokenSwapInstructionData::new().try_to_vec().unwrap();
...
pub struct TokenSwapInstructionData {
    discriminator: [u8; 8],
}

impl TokenSwapInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `TokenSwap`.
///
/// ### Accounts:
///
...
/// `token_swap` CPI accounts.
pub struct TokenSwapCpiAccounts<'a, 'b> {
...
/// `token_swap` CPI instruction.
pub struct TokenSwapCpi<'a, 'b> {
...
impl<'a, 'b> TokenSwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: TokenSwapCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `TokenSwap` via CPI.
///
/// ### Accounts:
///
///   0. `[]` token_swap_program
...
///   9. `[writable]` pool_mint
///   10. `[writable]` pool_fee
pub struct TokenSwapCpiBuilder<'a, 'b> {
    instruction: Box<TokenSwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> TokenSwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(TokenSwapCpiBuilderInstruction {
            __program: program,
...
struct TokenSwapCpiBuilderInstruction<'a, 'b> {
