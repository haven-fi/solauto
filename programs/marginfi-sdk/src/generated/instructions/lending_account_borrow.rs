...
impl LendingAccountBorrow {
  pub fn instruction(&self, args: LendingAccountBorrowInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LendingAccountBorrowInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = LendingAccountBorrowInstructionData::new().try_to_vec().unwrap();
