...
impl LendingAccountStartFlashloan {
  pub fn instruction(&self, args: LendingAccountStartFlashloanInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LendingAccountStartFlashloanInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = LendingAccountStartFlashloanInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> LendingAccountStartFlashloanCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn signer(&mut self, signer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn ixs_sysvar(&mut self, ixs_sysvar: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = LendingAccountStartFlashloanInstructionArgs {
                                            end_index: self.instruction.end_index.clone().expect("end_index is not set"),
                                    };
