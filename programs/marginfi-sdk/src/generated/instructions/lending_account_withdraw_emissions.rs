...
impl LendingAccountWithdrawEmissions {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = LendingAccountWithdrawEmissionsInstructionData::new().try_to_vec().unwrap();
...
impl LendingAccountWithdrawEmissionsBuilder {
  pub fn new() -> Self {
    ...
    pub fn emissions_auth(&mut self, emissions_auth: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn emissions_vault(&mut self, emissions_vault: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.emissions_vault = Some(emissions_vault);
                    self
    }
            #[inline(always)]
    pub fn destination_account(&mut self, destination_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
impl<'a, 'b> LendingAccountWithdrawEmissionsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn emissions_auth(&mut self, emissions_auth: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn emissions_vault(&mut self, emissions_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.emissions_vault = Some(emissions_vault);
                    self
    }
      #[inline(always)]
    pub fn destination_account(&mut self, destination_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          emissions_vault: self.instruction.emissions_vault.expect("emissions_vault is not set"),
