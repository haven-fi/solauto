...
impl LendingPoolAddBank {
  pub fn instruction(&self, args: LendingPoolAddBankInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LendingPoolAddBankInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = LendingPoolAddBankInstructionData::new().try_to_vec().unwrap();
...
pub struct LendingPoolAddBankInstructionArgs {
            pub bank_config: BankConfigCompact,
      }


/// Instruction builder for `LendingPoolAddBank`.
///
/// ### Accounts:
///
          ///   0. `[]` marginfi_group
...
#[derive(Default)]
pub struct LendingPoolAddBankBuilder {
...
impl LendingPoolAddBankBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = LendingPoolAddBank {
          ...
          let args = LendingPoolAddBankInstructionArgs {
  ...
  /// `lending_pool_add_bank` CPI accounts.
  pub struct LendingPoolAddBankCpiAccounts<'a, 'b> {
...
/// `lending_pool_add_bank` CPI instruction.
pub struct LendingPoolAddBankCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: LendingPoolAddBankInstructionArgs,
  }

impl<'a, 'b> LendingPoolAddBankCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: LendingPoolAddBankCpiAccounts<'a, 'b>,
              args: LendingPoolAddBankInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `LendingPoolAddBank` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` marginfi_group
          ...
          ///   12. `[]` token_program
          ///   13. `[]` system_program
pub struct LendingPoolAddBankCpiBuilder<'a, 'b> {
  instruction: Box<LendingPoolAddBankCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LendingPoolAddBankCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(LendingPoolAddBankCpiBuilderInstruction {
      __program: program,
              marginfi_group: None,
              admin: None,
              fee_payer: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = LendingPoolAddBankCpi {
...
struct LendingPoolAddBankCpiBuilderInstruction<'a, 'b> {
