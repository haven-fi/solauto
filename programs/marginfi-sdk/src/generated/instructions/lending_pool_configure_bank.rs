...
impl LendingPoolConfigureBank {
  pub fn instruction(&self, args: LendingPoolConfigureBankInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LendingPoolConfigureBankInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = LendingPoolConfigureBankInstructionData::new().try_to_vec().unwrap();
...
#[inline(always)]
      pub fn oracle(&mut self, oracle: OracleConfig) -> &mut Self {
        ...
        self
                ...
                /// `[optional argument]`
#[inline(always)]
      pub fn interest_rate_config(&mut self, interest_rate_config: InterestRateConfigOpt) -> &mut Self {
