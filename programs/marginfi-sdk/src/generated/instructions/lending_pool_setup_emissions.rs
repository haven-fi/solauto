...
impl LendingPoolSetupEmissions {
  pub fn instruction(&self, args: LendingPoolSetupEmissionsInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LendingPoolSetupEmissionsInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = LendingPoolSetupEmissionsInstructionData::new().try_to_vec().unwrap();
...
impl LendingPoolSetupEmissionsBuilder {
  pub fn new() -> Self {
    ...
    pub fn emissions_auth(&mut self, emissions_auth: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn emissions_token_account(&mut self, emissions_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.emissions_token_account = Some(emissions_token_account);
                    self
    }
            #[inline(always)]
    pub fn emissions_funding_account(&mut self, emissions_funding_account: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = LendingPoolSetupEmissions {
                              marginfi_group: self.marginfi_group.expect("marginfi_group is not set"),
                                        ...
                                        emissions_token_account: self.emissions_token_account.expect("emissions_token_account is not set"),
                                        emissions_funding_account: self.emissions_funding_account.expect("emissions_funding_account is not set"),
          ...
          let args = LendingPoolSetupEmissionsInstructionArgs {
                                            flags: self.flags.clone().expect("flags is not set"),
                                                                  ...
                                                                  total_emissions: self.total_emissions.clone().expect("total_emissions is not set"),
                                    };
...
impl<'a, 'b> LendingPoolSetupEmissionsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn bank(&mut self, bank: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn emissions_mint(&mut self, emissions_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.emissions_mint = Some(emissions_mint);
                    self
    }
      #[inline(always)]
    pub fn emissions_auth(&mut self, emissions_auth: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.emissions_auth = Some(emissions_auth);
                    self
    }
      #[inline(always)]
    pub fn emissions_token_account(&mut self, emissions_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.emissions_token_account = Some(emissions_token_account);
                    self
    }
      #[inline(always)]
    pub fn emissions_funding_account(&mut self, emissions_funding_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = LendingPoolSetupEmissionsInstructionArgs {
                                            flags: self.instruction.flags.clone().expect("flags is not set"),
                                                                  ...
                                                                  total_emissions: self.instruction.total_emissions.clone().expect("total_emissions is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          emissions_mint: self.instruction.emissions_mint.expect("emissions_mint is not set"),
                  
          emissions_auth: self.instruction.emissions_auth.expect("emissions_auth is not set"),
                  
          emissions_token_account: self.instruction.emissions_token_account.expect("emissions_token_account is not set"),
                  
          emissions_funding_account: self.instruction.emissions_funding_account.expect("emissions_funding_account is not set"),
