...
impl MarginfiAccountInitialize {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = MarginfiAccountInitializeInstructionData::new().try_to_vec().unwrap();
...
/// Instruction builder for `MarginfiAccountInitialize`.
///
/// ### Accounts:
///
          ///   0. `[]` marginfi_group
                      ///   1. `[writable, signer]` marginfi_account
                ///   2. `[signer]` authority
                      ///   3. `[writable, signer]` fee_payer
                ///   4. `[optional]` system_program (default to `11111111111111111111111111111111`)
#[derive(Default)]
pub struct MarginfiAccountInitializeBuilder {
...
impl MarginfiAccountInitializeBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = MarginfiAccountInitialize {
  ...
  /// `marginfi_account_initialize` CPI accounts.
  pub struct MarginfiAccountInitializeCpiAccounts<'a, 'b> {
...
/// `marginfi_account_initialize` CPI instruction.
pub struct MarginfiAccountInitializeCpi<'a, 'b> {
...
impl<'a, 'b> MarginfiAccountInitializeCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: MarginfiAccountInitializeCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `MarginfiAccountInitialize` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` marginfi_group
                ...
                ///   2. `[signer]` authority
                      ///   3. `[writable, signer]` fee_payer
          ///   4. `[]` system_program
pub struct MarginfiAccountInitializeCpiBuilder<'a, 'b> {
  instruction: Box<MarginfiAccountInitializeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> MarginfiAccountInitializeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(MarginfiAccountInitializeCpiBuilderInstruction {
      __program: program,
              marginfi_group: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = MarginfiAccountInitializeCpi {
...
struct MarginfiAccountInitializeCpiBuilderInstruction<'a, 'b> {
