...
impl MarginfiGroupConfigure {
  pub fn instruction(&self, args: MarginfiGroupConfigureInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: MarginfiGroupConfigureInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = MarginfiGroupConfigureInstructionData::new().try_to_vec().unwrap();
