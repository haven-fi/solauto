...
impl SetAccountFlag {
  pub fn instruction(&self, args: SetAccountFlagInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetAccountFlagInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = SetAccountFlagInstructionData::new().try_to_vec().unwrap();
...
impl SetAccountFlagInstructionData {
  fn new() -> Self {
    Self {
                        }
  }
...
pub struct SetAccountFlagInstructionArgs {
            pub flag: u64,
      }


/// Instruction builder for `SetAccountFlag`.
///
/// ### Accounts:
///
          ///   0. `[]` marginfi_group
                ...
                ///   2. `[signer]` admin
#[derive(Default)]
pub struct SetAccountFlagBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SetAccountFlag {
          ...
          let args = SetAccountFlagInstructionArgs {
  ...
  /// `set_account_flag` CPI accounts.
  pub struct SetAccountFlagCpiAccounts<'a, 'b> {
...
/// `set_account_flag` CPI instruction.
pub struct SetAccountFlagCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SetAccountFlagInstructionArgs,
  }

impl<'a, 'b> SetAccountFlagCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SetAccountFlagCpiAccounts<'a, 'b>,
              args: SetAccountFlagInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `SetAccountFlag` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` marginfi_group
                ///   1. `[writable]` marginfi_account
                ///   2. `[signer]` admin
pub struct SetAccountFlagCpiBuilder<'a, 'b> {
  instruction: Box<SetAccountFlagCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetAccountFlagCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SetAccountFlagCpiBuilderInstruction {
      __program: program,
              marginfi_group: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = SetAccountFlagCpi {
...
struct SetAccountFlagCpiBuilderInstruction<'a, 'b> {
