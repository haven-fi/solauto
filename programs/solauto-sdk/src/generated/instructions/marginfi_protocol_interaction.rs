...
pub struct MarginfiProtocolInteraction {
    ...
    pub position_supply_ta: Option<solana_program::pubkey::Pubkey>,
...
impl MarginfiProtocolInteraction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(position_supply_ta) = self.position_supply_ta {
            accounts.push(solana_program::instruction::AccountMeta::new(
                position_supply_ta,
                false,
            ));
...
pub struct MarginfiProtocolInteractionInstructionData {
    discriminator: u8,
}
...
///   10. `[optional]` supply_price_oracle
///   11. `[writable, optional]` position_supply_ta
///   12. `[writable, optional]` vault_supply_ta
///   13. `[writable, optional]` supply_vault_authority
///   14. `[writable]` debt_bank
///   15. `[optional]` debt_price_oracle
///   16. `[writable, optional]` position_debt_ta
...
impl MarginfiProtocolInteractionBuilder {
    ...
    pub fn position_supply_ta(
        ...
        self.position_supply_ta = position_supply_ta;
        self
    }
    /// `[optional account]`
    #[inline(always)]
...
pub struct MarginfiProtocolInteractionCpiAccounts<'a, 'b> {
    ...
    pub position_supply_ta: Option<&'b solana_program::account_info::AccountInfo<'a>>,
...
impl<'a, 'b> MarginfiProtocolInteractionCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        if let Some(position_supply_ta) = self.position_supply_ta {
            account_infos.push(position_supply_ta.clone());
        }
        if let Some(vault_supply_ta) = self.vault_supply_ta {
...
impl<'a, 'b> MarginfiProtocolInteractionCpiBuilder<'a, 'b> {
    ...
    pub fn position_supply_ta(
        ...
        self.instruction.position_supply_ta = position_supply_ta;
        self
    }
    /// `[optional account]`
    #[inline(always)]
    ...
    pub fn invoke_signed(
        ...
        let instruction = MarginfiProtocolInteractionCpi {
            ...
            position_supply_ta: self.instruction.position_supply_ta,
