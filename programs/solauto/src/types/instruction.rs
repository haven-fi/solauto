...
pub enum Instruction {
    ...
    #[account(name = "supply_reserve_pyth_oracle")]
    #[account(name = "supply_reserve_switchboard_oracle")]
    #[account(mut, name = "debt_reserve")]
    #[account(name = "debt_reserve_pyth_oracle")]
    #[account(name = "debt_reserve_switchboard_oracle")]
    #[account(name = "lending_market")]
    #[account(name = "obligation")]
    #[account(mut, name = "solauto_position")]
    #[account(name = "position_supply_liquidity_ta")]
    #[account(name = "position_debt_liquidity_ta")]
    SolendRefreshData,
    ...
    #[account(mut, name = "obligation")]
    #[account(mut, name = "supply_reserve")]
    #[account(optional, name = "supply_reserve_pyth_oracle")]
    ...
    #[account(mut, optional, name = "signer_supply_collateral_ta")]
