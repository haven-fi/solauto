...
exports.getMarginfiProtocolInteractionInstructionDataSerializer = getMarginfiProtocolInteractionInstructionDataSerializer;
exports.marginfiProtocolInteraction = marginfiProtocolInteraction;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
const types_1 = require("../types");
function getMarginfiProtocolInteractionInstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.u8)()],
        ['solautoAction', (0, types_1.getSolautoActionSerializer)()],
    ], { description: 'MarginfiProtocolInteractionInstructionData' }), (value) => ({ ...value, discriminator: 8 }));
}
// Instruction.
function marginfiProtocolInteraction(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getMarginfiProtocolInteractionInstructionDataSerializer().serialize(resolvedArgs);
