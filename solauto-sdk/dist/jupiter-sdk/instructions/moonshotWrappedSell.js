...
exports.getMoonshotWrappedSellInstructionDataSerializer = getMoonshotWrappedSellInstructionDataSerializer;
exports.moonshotWrappedSell = moonshotWrappedSell;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
function getMoonshotWrappedSellInstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([['discriminator', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })]], { description: 'MoonshotWrappedSellInstructionData' }), (value) => ({ ...value, discriminator: [248, 2, 240, 253, 17, 184, 57, 8] }));
}
// Instruction.
function moonshotWrappedSell(context, input) {
    // Program ID.
