...
exports.getSharedAccountsRouteInstructionDataSerializer = getSharedAccountsRouteInstructionDataSerializer;
exports.sharedAccountsRoute = sharedAccountsRoute;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
const types_1 = require("../types");
function getSharedAccountsRouteInstructionDataSerializer() {
    ...
    ], { description: 'SharedAccountsRouteInstructionData' }), (value) => ({
        ...value,
        discriminator: [193, 32, 155, 51, 65, 214, 156, 129],
    }));
}
// Instruction.
function sharedAccountsRoute(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getSharedAccountsRouteInstructionDataSerializer().serialize(resolvedArgs);
