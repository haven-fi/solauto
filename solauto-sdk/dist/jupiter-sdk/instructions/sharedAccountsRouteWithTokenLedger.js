...
exports.getSharedAccountsRouteWithTokenLedgerInstructionDataSerializer = getSharedAccountsRouteWithTokenLedgerInstructionDataSerializer;
exports.sharedAccountsRouteWithTokenLedger = sharedAccountsRouteWithTokenLedger;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
const types_1 = require("../types");
function getSharedAccountsRouteWithTokenLedgerInstructionDataSerializer() {
    ...
    ], { description: 'SharedAccountsRouteWithTokenLedgerInstructionData' }), (value) => ({
        ...value,
        discriminator: [230, 121, 143, 80, 119, 159, 106, 170],
    }));
}
// Instruction.
function sharedAccountsRouteWithTokenLedger(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getSharedAccountsRouteWithTokenLedgerInstructionDataSerializer().serialize(resolvedArgs);
