...
exports.getStepSwapInstructionDataSerializer = getStepSwapInstructionDataSerializer;
exports.stepSwap = stepSwap;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
function getStepSwapInstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([['discriminator', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })]], { description: 'StepSwapInstructionData' }), (value) => ({
        ...value,
        discriminator: [155, 56, 208, 198, 27, 61, 149, 233],
    }));
}
// Instruction.
function stepSwap(context, input) {
    // Program ID.
