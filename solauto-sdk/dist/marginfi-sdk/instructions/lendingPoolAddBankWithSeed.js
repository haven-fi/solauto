...
exports.getLendingPoolAddBankWithSeedInstructionDataSerializer = getLendingPoolAddBankWithSeedInstructionDataSerializer;
exports.lendingPoolAddBankWithSeed = lendingPoolAddBankWithSeed;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
const types_1 = require("../types");
function getLendingPoolAddBankWithSeedInstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ...
        ['bankSeed', (0, serializers_1.u64)()],
    ], { description: 'LendingPoolAddBankWithSeedInstructionData' }), (value) => ({
        ...value,
        discriminator: [76, 211, 213, 171, 117, 78, 158, 76],
    }));
}
// Instruction.
function lendingPoolAddBankWithSeed(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getLendingPoolAddBankWithSeedInstructionDataSerializer().serialize(resolvedArgs);
