...
export function getInterestRateConfigCompactSerializer(): Serializer<
  InterestRateConfigCompactArgs,
  InterestRateConfigCompact
> {
  return struct<InterestRateConfigCompact>(
    [
  ...
  ) as Serializer<InterestRateConfigCompactArgs, InterestRateConfigCompact>;
}
