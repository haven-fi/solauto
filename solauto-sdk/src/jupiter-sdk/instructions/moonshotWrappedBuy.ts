...
export function getMoonshotWrappedBuyInstructionDataSerializer(): Serializer<
  MoonshotWrappedBuyInstructionDataArgs,
  MoonshotWrappedBuyInstructionData
> {
  return mapSerializer<
    ...
    MoonshotWrappedBuyInstructionData
  >(
    struct<MoonshotWrappedBuyInstructionData>(
      [['discriminator', array(u8(), { size: 8 })]],
      { description: 'MoonshotWrappedBuyInstructionData' }
    ),
    (value) => ({
      ...value,
...
// Instruction.
export function moonshotWrappedBuy(
  context: Pick<Context, 'programs'>,
  input: MoonshotWrappedBuyInstructionAccounts
): TransactionBuilder {
  // Program ID.
